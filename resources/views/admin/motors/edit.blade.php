...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <div>
                <h2 class="page-title mb-1">Edit Motor</h2>
                <p class="page-subtitle">Perbarui data motor {{ $motor->plat_nomor }}</p>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" class="form-input @error('plat_nomor') is-invalid @enderror"
                                    id="plat_nomor" name="plat_nomor" value="{{ old('plat_nomor', $motor->plat_nomor) }}"
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" class="form-input @error('merk') is-invalid @enderror" id="merk"
                                    name="merk" value="{{ old('merk', $motor->merk) }}" placeholder="Contoh: Honda Beat"
                                    required>
                                @error('merk')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="number" class="form-input @error('tahun') is-invalid @enderror" id="tahun"
                                    name="tahun" value="{{ old('tahun', $motor->tahun) }}" placeholder="Contoh: 2023"
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" class="form-input @error('warna') is-invalid @enderror" id="warna"
                                    name="warna" value="{{ old('warna', $motor->warna) }}" placeholder="Contoh: Merah">
                                @error('warna')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="input-group-custom">
                                    ...
                                    <input type="number" class="form-input ps-5 @error('harga_sewa') is-invalid @enderror"
                                        ...
                                        value="{{ old('harga_sewa', $motor->harga_sewa) }}" placeholder="50000"
                                        min="0" required>
                                </div>
                                @error('harga_sewa')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" id="status"
                                    ...
                                    <option value="tersedia"
                                        {{ old('status', $motor->status) == 'tersedia' ? 'selected' : '' }}>Tersedia
                                    </option>
                                    <option value="disewa"
                                        {{ old('status', $motor->status) == 'disewa' ? 'selected' : '' }}>Disewa</option>
                                    <option value="servis"
                                        {{ old('status', $motor->status) == 'servis' ? 'selected' : '' }}>Servis</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <select class="form-select @error('kondisi') is-invalid @enderror" id="kondisi"
                                    ...
                                    <option value="baik"
                                        {{ old('kondisi', $motor->kondisi) == 'baik' ? 'selected' : '' }}>Baik</option>
                                    <option value="sedang"
                                        {{ old('kondisi', $motor->kondisi) == 'sedang' ? 'selected' : '' }}>Sedang</option>
                                    <option value="perlu_perbaikan"
                                        {{ old('kondisi', $motor->kondisi) == 'perlu_perbaikan' ? 'selected' : '' }}>Perlu
                                        Perbaikan</option>
                                </select>
                                @error('kondisi')
                                    <div class="invalid-feedback">{{ $message }}</div>
